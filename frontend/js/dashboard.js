...
const revenue = new Array(12).fill(0); //creates 12-element array with 0 as the initial value for each element
...
function updateChart(transactions) {
  ...
  financeChart.data.datasets[0].data = monthlyRevenue;
  financeChart.data.datasets[1].data = monthlyExpenses;
